...
import exception.ModbusIdException;
import locator.BaseLocator;
import locator.NumericLocator;
import locator.StringLocator;

import java.nio.charset.Charset;
import java.util.List;
import java.util.Map;

import static base.ModbusUtils.validateBit;
import static base.ModbusUtils.validateOffset;
