...
abstract public class ModbusMaster extends Modbus{
    ...
    public final ModbusResponse send(ModbusRequest request) throws ModbusTransportException{
        ...
        ModbusResponse modbusResponse = sendImple(request);
        if(validateResponse){
    ...
    abstract public ModbusResponse sendImple(ModbusRequest request) throws ModbusTransportException;
