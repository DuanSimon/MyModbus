...
public class BatchTest {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            int slaveId = 31;
            batchRead.addLocator("00011 sba true", BaseLocator.coilStatus(slaveId, 10));
            batchRead.addLocator("000012 sb false", BaseLocator.coilStatus(slaveId, 11));
            ...
            batchRead.addLocator("10001 sb false", BaseLocator.inputStatus(slaveId, 10));
