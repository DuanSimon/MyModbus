...
import com.simon.modbus4j.ProcessImageListener;
...
public class Test4 {
    ...
    private static Long fourByteIntSignedSwappedSwapped = new Long(-16777217); //Rgister 20
    private static Long register22 = new Long(2369859368L); // Register 22
